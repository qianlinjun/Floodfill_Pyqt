...
if __name__ ==  "__main__":
    ...
    # filedir  = "C:\qianlinjC:\qianlinjun\graduate\test-dataun\graduate\data\switz-test-pts-3-17-11-image-fov-60"
    filedir = r"C:\qianlinjun\graduate\test-data"

    # 85_8.58807087_46.664257
    json_file1 = os.path.join(filedir, "test-mountain.json")#"10_8.51592159_46.602951.json"
    json_file2 = os.path.join(filedir, "test-mountain.json")#"11_8.53155708_46.60886.json" 85_8.58807087_46.664257.json
