...
def cmp():
    ...
    # ori no angle dist del 0.9
    # y1 = (np.array([6, 7, 9, 10, 14, 16, 17, 17, 17, 17, 18, 18, 18, 18, 18, 18, 18, 18, 18, 18, 18, 19, 19, 19, 20]) - 1.5)/25. #原始算法

    # del 1.5
    y2 = (np.array([6, 10, 11, 13, 15, 16, 17, 17, 17, 17, 17, 18, 18, 18, 18, 18, 18, 18, 19, 19, 19, 19, 19, 19, 20]) - 1.5)/25. #原始算法
    ...
    # # y5 = np.array([7, 10, 11, 13, 15, 16, 17, 17, 17, 17, 17, 18, 18, 18, 18, 18, 18, 18, 19, 19, 19, 19, 19, 19, 20])/25.# 1_5


    # y5 = np.array([7, 8, 9, 10, 12, 12, 13, 13, 14, 14, 16, 16, 16, 17, 17, 17, 17, 17, 17, 17, 18, 19, 19, 19, 19])/25.
    # plt.title("直线图") 
    plt.xlabel("候选结果数量N") 
    plt.ylabel("图像正确定位比例") 
    plt.ylim(0, 1)
