...
def get_dist(poly1, poly1_id, poly2, poly2_id):
    ...
    mu20 = m1["nu20"]
    mu30 = m1["nu30"]
    angle1 = math.atan(2*mu11/(mu20 - mu02))/2.*180/3.1415926 #such as pi0 > & and I.&, > 0,
    print("poly1 angle", angle1, mu20 ,mu02, mu30) #*180/3.1415926
    ...
    print("poly2 angle", angle2, mu20 ,mu02, mu30) #*180/3.1415926
...
if __name__ ==  "__main__":
    ...
    # filedir  = "C:\qianlinjun\graduate\data\switz-test-pts-3-17-11-image-fov-60"
    # 85_8.58807087_46.664257
    # json_file1 = os.path.join(filedir, "15_8.56048775_46.6160736.json")#"10_8.51592159_46.602951.json"
    # json_file2 = os.path.join(filedir, "16_8.56394863_46.6178322.json")#"11_8.53155708_46.60886.json" 85_8.58807087_46.664257.json

    filedir = "C:\qianlinjun\graduate\gen_dem\output\img_with_mask\switz-100-points"
    json_file1 = os.path.join(filedir, "83_8.58592987_46.6606636.json")
    json_file2 = os.path.join(filedir, "83_8.58592987_46.6606636.json")
    ...
    for point1_id in [11]:
        for point2_id in [12]:
            ...
            if poly1 is not None and poly2 is not None:
                ...
                shape_cost = get_dist(poly1, point1_id, poly2, point2_id)
